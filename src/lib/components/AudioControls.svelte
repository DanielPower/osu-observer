<script lang="ts">
	...
	export let optionsPopoverId: string = 'options-popover';
...
<div class="flex w-full flex-wrap items-center gap-2 rounded bg-slate-700 p-2">
	...
	<button
		class="options-button flex h-10 w-10 items-center justify-center rounded-full bg-slate-600 text-white transition-colors hover:bg-slate-500 focus:outline-none"
		popovertarget={optionsPopoverId}
		aria-label="Open options"
		style="anchor-name: --options-button"
	>
